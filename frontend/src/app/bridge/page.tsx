...
export default function Bridge() {
  ...
  return (
    <main className="relative flex flex-col items-center justify-between p-12" style={{ height: '80vh' }}>
      {currentStep > 0 && (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white bg-opacity-90 py-8 px-12 rounded-lg shadow-md">
        <p className="text-xl font-bold">Step {currentStep}/3</p>
        {currentStep === 1 && <p>Sending intent to data layer</p>}
        {currentStep === 2 && <p>Awaiting user transaction</p>}
        {currentStep === 3 && <p>Confirming transaction on data layer</p>}
      </div>
      )}
