...
/// The Arbitrum Sepolia testnet specification.
pub static ARB_SEPOLIA_CHAIN_SPEC: Lazy<ChainSpec> = Lazy::new(|| ChainSpec {
    chain_id: 421614,
    max_spec_id: SpecId::SHANGHAI, // Replace with actual value
    hard_forks: BTreeMap::from([
        (SpecId::MERGE, ForkCondition::Block(123)),
        (SpecId::SHANGHAI, ForkCondition::Timestamp(1681338455)),
    ]),
    gas_constants: BTreeMap::from([(SpecId::LONDON, EIP1559_CONSTANTS_DEFAULT)]), // Replace with actual values
});
